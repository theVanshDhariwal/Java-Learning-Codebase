package Java.Concept_Wise.Java_8.Stream;
...
//        List<String> list1 = stream.map(String::toUpperCase).toList(); // exception
        ...
        Definition :
        A stateless operation does not depend on or modify any stored data.
        Each call is independent and depends only on the input parameters.

        2. Stateful Operation
        Definition :
        A stateful operation depends on or modifies internal state stored in instance variables.
        The result may vary depending on previous interactions.
        */
